      ...
      <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
              <a href="<?php echo base_url()?>">
                  <img src="<?php echo base_url();?>/assets/dashboard/brand/UPAOLogin.png" width="110" height="32"
          ...
          <div class="navbar-nav flex-row order-md-last">
                              ...
                              <div class="divide-y-4">
                                  ...
                                  <div>
                                      <div class="row">
                                          <div class="col-auto">
                                              <span class="avatar"
                                                  style="background-image: url(https://media-exp1.licdn.com/dms/image/C4E03AQF1W1bb6ry-4w/profile-displayphoto-shrink_200_200/0/1583642648019?e=1619049600&v=beta&t=cqGB2-s4sZp3Vc6ayx0366iiA5Mgt3nlcM-exOkN71A)"></span>
                                          </div>
                                          <div class="col">
                                              <div class="text-truncate">
                                  ...
                                  <div>
                                      ...
                                      <div class="row text-center align-items-center flex-row-reverse">
                                          ...
                                          <a href="<?php echo base_url("/DashboardUser/Notification");?>">Ver Todas</a>
              ...
              <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <a href="<?php echo base_url(); ?>DashboardUser/Profile" class="dropdown-item">Perfil</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
              <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                  <ul class="navbar-nav">
                      <li class="nav-item">
                          <a class="nav-link" href="<?php echo base_url("/DashboardUser/Index");?>">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="<?php echo base_url("/DashboardUser/Employment_profile");?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block"><svg
                                      xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                      stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="<?php echo base_url("/DashboardUser/Professional_profile");?>">
                              <span class="nav-link-icon d-md-none d-lg-inline-block"><svg
                                      xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                      stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="<?php echo base_url("/DashboardUser/Further_training");?>">
